public class Pawn {
    ...
    public boolean isMoveLegal(Board board, int endRow, int endCol) {
        if (board.verifyVertical(this.row, this.col, endRow, endCol) && board.getPiece(endRow, endCol) == null) {
            // Case 1: Forward movement to an empty square.
        ...
        } else if ((this.col == endCol + 1 || this.col == endCol - 1) && board.verifyAdjacent(this.row, this.col, endRow, endCol)) {
            // Case 2: Capturing a piece in an adjacent square.
            ...
            // Case 3: Moving in a non-adjacent column or an invalid move.
            return false;
        }
    }
